...
export const occCmsStructureModel: CmsStructureModel = {
  page: {
    ...
    slots: {
      tiles_body: {
        components: [
          {
            uid: 'tiles_body_component',
            typeCode: 'tilesBodyComponent',
            flexType: 'tilesBodyComponent',
          },
        ],
      },
      main_navigation: {
        components: [
          {
            uid: 'main_navigation_component',
            typeCode: 'mainNavigationComponent',
            flexType: 'mainNavigationComponent',
          },
        ],
      },
      stage_body: {
        components: [
          {
            uid: 'component1',
            typeCode: 'component1Type',
            flexType: 'component1Type',
          },
        ],
      },
      main_body: {
        components: [
          {
            uid: 'component2',
            typeCode: 'component2Type',
            flexType: 'component2Type',
          },
        ],
      },
    },
  ...
  components: [
    ...
    },
    {
      ...
      typeCode: 'component1Type',
      otherProperties: {
        data: 'tiles_body_component_data',
      },
    },
    {
      uid: 'main_navigation_component',
      typeCode: 'mainNavigationComponent',
      otherProperties: {
        data: 'main_navigation_component_data',
      },
    },
  ],
};

const caasDocument: FsCmsPageInterface = {
