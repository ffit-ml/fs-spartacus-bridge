...
function createResponse(seoUrl: string, language: string): FsCmsPageInterface {
  return {
    ...
    locale: {
      identifier: language.toUpperCase(),
...
export const fsCmsPageInterfaceJsonEn: FsCmsPageInterface = copy(createResponse('test_seo_route', 'en'));
export const fsCmsPageInterfaceJsonDe: FsCmsPageInterface = copy(createResponse('test_seo_route', 'de'));
export const fsCmsPageInterfaceJsonAr: FsCmsPageInterface = copy(createResponse('test_seo_route', 'ar'));
export const fsCmsPageInterfaceJsonFr: FsCmsPageInterface = copy(createResponse('', 'fr'));
...
export const caasFilterResult = {
  ...
  _returned: 4,
  _embedded: {
    'rh:doc': [fsCmsPageInterfaceJsonDe, fsCmsPageInterfaceJsonEn, fsCmsPageInterfaceJsonAr, fsCmsPageInterfaceJsonFr],
  },
};
