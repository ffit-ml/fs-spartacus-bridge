...
export const fsCmsPageWithSapSkeleton: CmsStructureModel = {
  page: {
    loadTime: 1602835902476,
    name: 'fsdrivenlandingpage2template',
    type: 'PageRef',
    pageId: 'fsdrivenlandingpage2template',
    slots: { section1: { components: [] } },
    properties: {
    ...
    template: 'fsdrivenlandingpage2template',
  },
  components: [],
};

export const fsDrivenCmsPage: CmsStructureModel = {
  page: {
    loadTime: 1602835902476,
    name: 'fsdrivenpagetemplate',
    type: 'PageRef',
    pageId: 'fsdrivenpagetemplate',
    slots: { section1: { components: [] } },
    properties: {
      previewId: '688442cf-93be-4a0a-a01f-9d7d05be7172.en_GB',
      formData: {
